...
## Admin Account for Clearing and Restarting Rounds:
...
Replace `hotkey3` with the hotkey label for the validator you are signing in as (`hotkey3` for Validator 1, `hotkey1` for Validator 2). The script prints a `0x...` hex signature.
...
| miner4 / hotkey1 | 5FX83fd6KGqzWkUhv2pcF6PZBgzenZ8ZouupFo2QZcckB2ce |
| miner4 / hotkey3 | 5HVnKyUnSTAszMjE3rjyaqVfV9rjPG69gFxC8fxiHjXEHpR2 |
| miner4 / hotkey2 | 5EKu83YjNJm5WvkGLPdCZ1WrHYfNcMKW5pmEpZKEj4kRWuTG |
